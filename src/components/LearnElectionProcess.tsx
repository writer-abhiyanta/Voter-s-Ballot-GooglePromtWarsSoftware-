...
const STEPS: ElectionStep[] = [
  {
    ...
    description:
      "Ensure you are registered to vote before the deadline. Keep your voter ID ready.",
    icon: FileCheck,
  ...
  },
  {
    ...
    description:
      "Learn about candidates and their manifestos to make an informed decision.",
    icon: Users,
    color: "text-emerald-500",
    bg: "bg-emerald-500/10",
  },
  {
    ...
    description:
      "Locate your designated polling booth on the map and plan your visit on election day.",
    icon: Vote,
    color: "text-emerald-500",
    bg: "bg-emerald-500/10",
  },
  {
    ...
    description:
      "Go to the polling booth, verify identity, give your informed vote on evm unravelingly.",
    icon: CheckCircle2,
    color: "text-emerald-500",
    bg: "bg-emerald-500/10",
  },
  {
    ...
    description:
      "Track the promises made in the manifesto and see what has been accomplished.",
    icon: ListTodo,
    color: "text-emerald-500",
    bg: "bg-emerald-500/10",
  },
  {
    ...
    description:
      "Hold elected officials accountable by asking questions about incomplete promises.",
 ...
 */
export const LearnElectionProcess: React.FC<{ onComplete?: () => void }> = ({
  onComplete,
}): React.ReactElement => {
  ...
  return (
    ...
    >
      <header className="text-center mb-12">
        ...
        >
          Gamified Election Learning
        </h2>
        <p className="text-neutral-400">
          Master the election process to give an easy and informed vote.
        </p>
      </header>
      ...
      <div className="w-full relative">
        ...
        >
          <div
            className="absolute top-1/2 left-8 right-8 h-1 bg-neutral-800 -z-10 -translate-y-1/2"
            aria-hidden="true"
          >
            <motion.div
          ...
          {STEPS.map((s, idx) => (
            <div
              key={s.id}
              className={`w-8 h-8 rounded-full flex items-center justify-center border-2 transition-colors duration-500 ${idx <= currentStep ? "bg-emerald-500 border-emerald-500" : "bg-neutral-900 border-neutral-700"}`}
              aria-hidden="true"
            >
              {idx < currentStep ? (
        ...
        <AnimatePresence mode="wait">
          {!isCompleted ? (
            ...
            >
              <div
                className={`w-24 h-24 mx-auto rounded-2xl flex items-center justify-center mb-8 ${step.bg}`}
                aria-hidden="true"
              >
            ...
            >
              <div
                className="w-32 h-32 mx-auto rounded-full bg-emerald-500/20 flex items-center justify-center mb-8 border-4 border-emerald-500/50 shadow-[0_0_50px_rgba(16,185,129,0.3)]"
                aria-hidden="true"
              >
              ...
              <h3 className="text-3xl font-bold mb-4 text-emerald-400">
                Badge of Informed Voter Earned!
              </h3>
