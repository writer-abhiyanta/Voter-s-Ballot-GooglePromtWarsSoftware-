...
export const CandidateDiscovery: React.FC = (): React.ReactElement => {
    ...
    return [...CANDIDATES]
      .map((cand) => {
        ...
        const matchScore = Math.round(
          (totalScore / QUIZ_QUESTIONS.length) * 100,
        );
  ...
  useEffect(() => {
    if (
      currentIndex >= matchedCandidates.length &&
  ...
  if (phase === "intro") {
    return (
      <div
        className="flex flex-col items-center justify-center h-full text-center p-8 bg-neutral-950 rounded-3xl"
      ...
      >
        <Activity
          ...
          aria-hidden="true"
        />
        <h2 id="intro-title" className="text-2xl font-bold text-white mb-4">
          Discover Your Candidates
        </h2>
        <p className="text-neutral-400 mb-8 max-w-lg mx-auto">
          Take a quick 5-question match quiz to see which candidates align best
    ...
    return (
      ...
      >
        <div className="w-full mb-8">
          ...
          <div
            className="w-full h-2 bg-neutral-800 rounded-full overflow-hidden"
            role="progressbar"
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <h3
              id="quiz-question"
              className="text-2xl font-medium text-white text-center mb-10 leading-relaxed min-h-[100px]"
            >
              "{question.text}"
            </h3>
    ...
    return (
      ...
      >
        ...
        <p className="text-neutral-400 max-w-sm mx-auto mb-8">
          You've reviewed all candidates in your district. Check your shortlist
          ...
          <div className="relative h-1/2 w-full">
            ...
            <div className="absolute top-4 right-4 bg-emerald-950/80 backdrop-blur-md px-3 py-1.5 rounded-full border border-emerald-500/30 flex items-center gap-2 shadow-[0_0_15px_rgba(16,185,129,0.3)]">
              <span
                ...
                aria-label={`Match score ${candidate.matchScore}%`}
              >
                {candidate.matchScore}%
              </span>
              <span
                className="text-emerald-300/80 text-xs text-uppercase tracking-wider"
                aria-hidden="true"
              >
                Match
              </span>
          ...
          <div className="p-6 h-1/2 flex flex-col justify-between" tabIndex={0}>
            <div>
              <div className="flex justify-between items-end mb-1">
                <h2 className="text-2xl font-bold text-white capitalize leading-none">
                  {candidate.name}
                </h2>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2 items-start w-full mt-1">
                  ...
                  <span
                    className={`text-xs font-semibold ${candidate.criminalRecord === "None" ? "text-emerald-400" : "text-amber-400"}`}
                  >
            ...
            <div className="pt-4 border-t border-neutral-800">
              <p className="text-neutral-500 text-[10px] uppercase tracking-wider mb-1">
                Past Performance
              </p>
              <p className="text-white text-xs italic opacity-80">
