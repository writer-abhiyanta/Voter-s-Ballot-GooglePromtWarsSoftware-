...
const MANIFESTO_DATA: ManifestoData[] = [
  {
    ...
    promises: [
      {
        id: "1a",
        text: "100% Renewable Energy by 2030",
        status: "in-progress",
        update: "Feasibility study completed. Solar panel subsidies drafted.",
      },
      {
        id: "1b",
        text: "Free Universal Pre-K",
        status: "completed",
        update: "Funding secured in the 2026 budget.",
      },
      {
        id: "1c",
        text: "Modernize Public Transit Network",
        status: "todo",
        update: "Awaiting federal grant approval.",
      },
    ],
  },
  {
    ...
    promises: [
      {
        id: "2a",
        text: "Comprehensive Tax Reform",
        status: "todo",
        update: "Drafting initial committee proposal.",
      },
      {
        id: "2b",
        text: "Increase Teacher Salaries by 15%",
        status: "in-progress",
        update: "Negotiating with teachers union.",
      },
      {
        id: "2c",
        text: "Expand Small Business Grants",
        status: "completed",
        update: "$5M grant program launched last month.",
      },
    ],
  },
  {
    ...
    promises: [
      {
        id: "3a",
        text: "Stop Urban Sprawl",
        status: "in-progress",
        update: "Zoning laws are being reviewed by the city council.",
      },
      {
        id: "3b",
        text: "Protect Local Watersheds",
        status: "completed",
        update: "New conservation zones established.",
      },
      {
        id: "3c",
        text: "Implement City-wide Composting",
        status: "in-progress",
        update: "Pilot program active in 3 neighborhoods.",
      },
    ],
  },
];
...
export const ManifestoTracker: React.FC = (): React.ReactElement => {
  ...
  const activeCandidate = MANIFESTO_DATA.find(
    ...
    <section className="flex flex-col h-full" aria-labelledby="manifesto-title">
      <header className="mb-8">
        ...
        <p className="text-neutral-400">
          Track the progress of candidates' electoral promises and hold them
          accountable.
        </p>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 flex-1">
        {/* Candidates List */}
        <nav
          className="col-span-1 border border-neutral-800 rounded-2xl bg-neutral-900 overflow-hidden flex flex-col"
          aria-label="Select a candidate to view their manifesto"
        >
          <div className="p-4 border-b border-neutral-800 bg-neutral-950/50">
            <h3 className="font-semibold text-neutral-300 uppercase tracking-wider text-xs">
              Candidates
            </h3>
          </div>
          <div
        ...
        <section
          ...
          role="tabpanel"
          aria-labelledby={
            activeCandidate ? `candidate-tab-${activeCandidate.id}` : undefined
          }
          tabIndex={0}
        >
          {activeCandidate && (
            <div className="p-6 h-full overflow-y-auto w-full">
              <header className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-emerald-400 font-medium">
                    {activeCandidate.party} • Implementation Tracker
                  </p>
                </div>
              </header>
              ...
              <div
                className="space-y-4"
                role="list"
                aria-label={`Promises by ${activeCandidate.name}`}
              >
                {activeCandidate.promises.map((promise, index) => (
                  ...
                  >
                    <div
                      className="absolute top-0 left-0 w-1 h-full bg-neutral-800 group-hover:bg-emerald-500/50 transition-colors"
                      aria-hidden="true"
                    />
