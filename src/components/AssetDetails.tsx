...
export const AssetDetails: React.FC = () => {
  ...
  const filteredCandidates = CANDIDATES_ASSETS.filter(
    (c) =>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
          ...
          <p className="text-neutral-400">
            Review declared assets to identify and report potential fraud or
            ...
            <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="space-y-4">
                ...
                {candidate.properties.map((prop, i) => (
                  <div
                    key={i}
                    className="bg-neutral-800/50 p-3 rounded-lg flex justify-between items-center border border-neutral-800"
                  >
                    <div>
                ...
                {candidate.businesses.length > 0 ? (
                  <ul className="space-y-2">
                    {candidate.businesses.map((biz, i) => (
                      <li
                        key={i}
                        className="bg-neutral-800/50 p-3 rounded-lg border border-neutral-800 text-white text-sm font-medium flex items-center gap-2"
                      >
